const CACHE_NAME = 'cache-v18'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v18',
    'estilos/styles.css?v18',
    'estilos/mediaQueries.css?v18',
    'javascript/script.js?v18',
